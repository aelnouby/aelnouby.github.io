...
---
We introduce an end-to-end two-stream network for real-time action detection, integrating optical flow and visual streams in a jointly trained pipeline.
